...
var Car = function () {
 	...
 	* @params {function} Callback function to run after credentials are entered.
 	*/
	 ...
	 * Privileged method, to get access to user credentials
			...
			if (vehicles.id == undefined) {
				...
				teslams.get_climate_state( vehicles.id, function ( cs ) {
					...
					teslams.set_temperature( {id: vehicles.id, dtemp: temp, ptemp: temp}, function(e) {
						winston.info("Temperature is set at "+temp+"C");
